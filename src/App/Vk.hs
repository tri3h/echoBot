...
makeConnectionInfoReq :: BS.ByteString -> BS.ByteString -> Request
...
getMessage :: Logger.Handle IO -> ConnectionInfo -> Request -> StateT Bot.RepeatNumState IO (Maybe Message)
...
makeRequest :: BS.ByteString -> BS.ByteString -> Query -> Request
makeRequest path host param =
...
makeUpdateReqFromMessage :: ConnectionInfo -> Maybe Message -> StateT Bot.RepeatNumState IO Request
...
makeUpdateReq :: ConnectionInfo -> UpdateID -> StateT Bot.RepeatNumState IO Request
...
markAsReadMes :: Logger.Handle IO -> ConnectionInfo -> BS.ByteString -> Message -> StateT Bot.RepeatNumState IO ()
markAsReadMes logger info token mes = do
  let param =
